...
const SignUp = () => {
  const { createUser, profileUpdate, googleSignIn, logOut } =
          ...
          <div className="card-body">
            ...
            <form onSubmit={handleSignUp}>
              ...
              <div className="form-control mt-6">
                <button className="btn bg-gradient-to-r from-sky-500 to-indigo-500 text-black">
                  Sign Up
                </button>
              </div>
            </form>
            <div>
              <button
                ...
                className="btn w-full my-4 bg-cyan-800"
              >
